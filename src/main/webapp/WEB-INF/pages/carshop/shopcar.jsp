            ...
            <section id="content" class="twelve columns">
                ...
                <div class="recent-list-cars">
                    <ul class="recent-list-cars clearfix">
                        <c:forEach items="${allSearchCar}" var="shopcar">
                            <li>
                                <a href="/detail?carId=${shopcar.cId}" class="single-image picture">
                                    <img src="${shopcar.imgurl}" alt="" />
                                </a>

                                <a href="/detail?carId=${shopcar.cId}" class="list-meta">
                                    <h6 class="title-list-item">${shopcar.createTime}</h6>
                                </a>

                                <div class="detailed">
                                    <span class="cost">$${shopcar.totalPrice}万</span>
                                </div><!--/ .detailed-->

                                <a href="/detail?carId=${shopcar.cId}" class="button orange">Details</a>
                                    <%--<label class="compare"><input type="checkbox" />Compare</label>--%>
                                <a href="/deleteShopcar/${shopcar.scId}" class="button orange">Delete</a>
                            </li>
                        </c:forEach>
