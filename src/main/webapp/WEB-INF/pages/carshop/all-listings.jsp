				...
				<div class="recent-list-cars">
					...
					<ul class="recent-list-cars clearfix">
						<c:forEach items="${allSearchCar}" var="car">
							<li>
								<a href="/details?carId=${car.cId}" class="single-image picture">
									<img src="${car.imgurl}" alt="" />
								</a>

								<a href="/details?carId=${car.cId}" class="list-meta">
								...
								<a href="/details?carId=${car.cId}" class="button orange">Details</a>
